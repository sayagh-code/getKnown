...
const Footer = () => {
  return (
    <div className='w-full mt-24 bg-gray-900 text-gray-300 py-2 px-2'>
        <div className='max-w-[1400px] mx-auto grid grid-cols-2 md:grid-cols-5 border-b-2 border-gray-600 py-8 px-4'>
            <div>
                <h6 className='font-bold uppercase pt-2'>Solutions</h6>
                <ul>
                    <li className='py-1'>Read Tags</li>
                    <li className='py-1'>Write Tags</li>
                    <li className='py-1'>Generate Tags</li>
                    <li className='py-1'>Linking</li>
                    <li className='py-1'>Distributing</li>
                </ul>
            </div>
            <div>
