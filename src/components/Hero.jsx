        ...
        <div className='absolute top-0 w-full h-full flex flex-col justify-center text-white'>
            <div className='md:left-[10%] max-w-[1100px] m-auto absolute p-4'>
                ...
                <p className='max-w-[600px] drop-shadow-2xl py-2 text-xl'>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Alias tempore sequi labore illum deleniti expedita 
                    doloremque distinctio, maiores asperiores facere, similique sed adipisci numquam. Neque vel possimus corrupti at.
                    Consequatur!
                </p>
